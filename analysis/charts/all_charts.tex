...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Relative performance for with- vs without-\texttt{PreFlatten} on the MLton benchmark suite. Data: \protect\nolinkurl{test_tuple_flatten_test_o3:flattening-tests:cd5550ce5:20260909_191612.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{Relative performance for with- vs without-\texttt{PreFlatten}, applied to \texttt{ConApp} on the MLton benchmark suite. Data: \protect\nolinkurl{test_conapp_flatten_test_o3:flattening-tests:cd5550ce5:20260909_171650.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:con_mlton}
\end{figure}
...
\clearpage
\section{Aos Sync Gc Flattening}

\subsection{\texttt{parallel-ml-bench}: MPL vs MPL (Aos Sync Gc Flattening)}

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{aos_sync_gc_parallel_bench_run_mpl_vs_mpl.pdf}
    \caption{Run time}
    \label{fig:aos_sync_gc_parallel_bench_run_mpl_vs_mpl}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{aos_sync_gc_parallel_bench_size_mpl_vs_mpl.pdf}
    \caption{Binary size}
    \label{fig:aos_sync_gc_parallel_bench_size_mpl_vs_mpl}
  \end{subfigure}
  \caption{Relative performance for \texttt{aos\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_parallel_bench_mpl}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{aos_sync_gc_parallel_bench_run_mpl_vs_mpl_geomean.pdf}
  \caption{Relative performance for \texttt{aos\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_parallel_bench_mpl_geomean}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{aos_sync_gc_parallel_bench_run_mpl_vs_mpl_trellis.pdf}
  \caption{Relative performance for \texttt{aos\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_parallel_bench_mpl_trellis}
\end{figure}

\clearpage
\section{Aos Fixed Iters Flattening}

\subsection{\texttt{parallel-ml-bench}: MPL vs MPL (Aos Fixed Iters Flattening)}

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{aos_fixed_iters_parallel_bench_run_mpl_vs_mpl.pdf}
    \caption{Run time}
    \label{fig:aos_fixed_iters_parallel_bench_run_mpl_vs_mpl}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{aos_fixed_iters_parallel_bench_size_mpl_vs_mpl.pdf}
    \caption{Binary size}
    \label{fig:aos_fixed_iters_parallel_bench_size_mpl_vs_mpl}
  \end{subfigure}
  \caption{Relative performance for \texttt{aos\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_parallel_bench_mpl}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{aos_fixed_iters_parallel_bench_run_mpl_vs_mpl_geomean.pdf}
  \caption{Relative performance for \texttt{aos\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_parallel_bench_mpl_geomean}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{aos_fixed_iters_parallel_bench_run_mpl_vs_mpl_trellis.pdf}
  \caption{Relative performance for \texttt{aos\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_parallel_bench_mpl_trellis}
\end{figure}

\clearpage
\section{Soa Sync Gc Flattening}

\subsection{\texttt{parallel-ml-bench}: MPL vs MPL (Soa Sync Gc Flattening)}

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{soa_sync_gc_parallel_bench_run_mpl_vs_mpl.pdf}
    \caption{Run time}
    \label{fig:soa_sync_gc_parallel_bench_run_mpl_vs_mpl}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{soa_sync_gc_parallel_bench_size_mpl_vs_mpl.pdf}
    \caption{Binary size}
    \label{fig:soa_sync_gc_parallel_bench_size_mpl_vs_mpl}
  \end{subfigure}
  \caption{Relative performance for \texttt{soa\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_sync_gc:260912-205545:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-205545.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_sync_gc_parallel_bench_mpl}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{soa_sync_gc_parallel_bench_run_mpl_vs_mpl_geomean.pdf}
  \caption{Relative performance for \texttt{soa\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_sync_gc:260912-205545:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-205545.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_sync_gc_parallel_bench_mpl_geomean}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{soa_sync_gc_parallel_bench_run_mpl_vs_mpl_trellis.pdf}
  \caption{Relative performance for \texttt{soa\_sync\_gc} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_sync_gc:260912-205545:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-205545.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_sync_gc_parallel_bench_mpl_trellis}
\end{figure}

\clearpage
\section{Soa Fixed Iters Flattening}

\subsection{\texttt{parallel-ml-bench}: MPL vs MPL (Soa Fixed Iters Flattening)}

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{soa_fixed_iters_parallel_bench_run_mpl_vs_mpl.pdf}
    \caption{Run time}
    \label{fig:soa_fixed_iters_parallel_bench_run_mpl_vs_mpl}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{soa_fixed_iters_parallel_bench_size_mpl_vs_mpl.pdf}
    \caption{Binary size}
    \label{fig:soa_fixed_iters_parallel_bench_size_mpl_vs_mpl}
  \end{subfigure}
  \caption{Relative performance for \texttt{soa\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_fixed_iters:260914-135505:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-135505.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_fixed_iters_parallel_bench_mpl}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{soa_fixed_iters_parallel_bench_run_mpl_vs_mpl_geomean.pdf}
  \caption{Relative performance for \texttt{soa\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_fixed_iters:260914-135505:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-135505.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_fixed_iters_parallel_bench_mpl_geomean}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{soa_fixed_iters_parallel_bench_run_mpl_vs_mpl_trellis.pdf}
  \caption{Relative performance for \texttt{soa\_fixed\_iters} on the \texttt{parallel-ml-bench} benchmark suite, for the MPL compiler, at a variety of core counts. Data: \protect\nolinkurl{mpl_soa_vs_soa_fixed_iters:260914-135505:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-135505.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:soa_fixed_iters_parallel_bench_mpl_trellis}
\end{figure}
...
\subsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (AoS Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{linearrec_default_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{linearrec} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}.}
  \label{fig:linearrec_default_aos_mpl_parallel_ml_bench_scatter}
\end{figure}

\subsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (Aos Sync Gc Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{linearrec_sync_gc_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{linearrec} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}.}
  \label{fig:linearrec_sync_gc_aos_mpl_parallel_ml_bench_scatter}
\end{figure}

\subsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (AoS Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{quickhull_default_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{quickhull} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}.}
  \label{fig:quickhull_default_aos_mpl_parallel_ml_bench_scatter}
\end{figure}

\subsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (Aos Sync Gc Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{quickhull_sync_gc_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{quickhull} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}.}
  \label{fig:quickhull_sync_gc_aos_mpl_parallel_ml_bench_scatter}
\end{figure}

\subsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (Aos Fixed Iters Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{linearrec_fixed_iters_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{linearrec} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}.}
  \label{fig:linearrec_fixed_iters_aos_mpl_parallel_ml_bench_scatter}
\end{figure}

\subsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (Aos Fixed Iters Flattening))}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{quickhull_fixed_iters_aos_mpl_parallel_ml_bench_scatter.pdf}
  \caption{Per-trial execution times for \texttt{quickhull} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}.}
  \label{fig:quickhull_fixed_iters_aos_mpl_parallel_ml_bench_scatter}
\end{figure}
...
\subsection{Aos Exp Geomean}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_exp_geomean.pdf}
  \caption{Comparison of geometric mean speedups across core counts for \texttt{aos\_exp\_geomean}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_chunkify_one:260908-025502:flattening-tests:ab3558968f943135eaa66e7738b2363ca2b81f71:260908-025502.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_chunkify_func:260908-012113:flattening-tests:ab3558968f943135eaa66e7738b2363ca2b81f71:260908-012113.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_exp_geomean}
\end{figure}

\subsection{Aos Sync Gc Geomean}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_sync_gc_geomean.pdf}
  \caption{Comparison of geometric mean speedups across core counts for \texttt{aos\_sync\_gc\_geomean}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_geomean}
\end{figure}

\subsection{Aos Sync Gc Linearrec}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_sync_gc_linearrec.pdf}
  \caption{Comparison of \texttt{linearrec} speedups across core counts for \texttt{aos\_sync\_gc\_linearrec}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_linearrec}
\end{figure}

\subsection{Aos Sync Gc Quickhull}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_sync_gc_quickhull.pdf}
  \caption{Comparison of \texttt{quickhull} speedups across core counts for \texttt{aos\_sync\_gc\_quickhull}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_sync_gc:260912-192129:flattening-tests:c332d1391205d178b4d667102fffda834a4c89f9:260912-192129.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_sync_gc_quickhull}
\end{figure}

\subsection{Aos Fixed Iters Geomean}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_fixed_iters_geomean.pdf}
  \caption{Comparison of geometric mean speedups across core counts for \texttt{aos\_fixed\_iters\_geomean}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_geomean}
\end{figure}

\subsection{Aos Fixed Iters Linearrec}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_fixed_iters_linearrec.pdf}
  \caption{Comparison of \texttt{linearrec} speedups across core counts for \texttt{aos\_fixed\_iters\_linearrec}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_linearrec}
\end{figure}

\subsection{Aos Fixed Iters Quickhull}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_fixed_iters_quickhull.pdf}
  \caption{Comparison of \texttt{quickhull} speedups across core counts for \texttt{aos\_fixed\_iters\_quickhull}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_fixed_iters:260914-130756:flattening-tests:04ef12979aba919263dc1abf2cf294a744caf6d9:260914-130756.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_fixed_iters_quickhull}
\end{figure}

\subsection{Aos Chunkify One Geomean}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_chunkify_one_geomean.pdf}
  \caption{Comparison of geometric mean speedups across core counts for \texttt{aos\_chunkify\_one\_geomean}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_chunkify_one:260908-025502:flattening-tests:ab3558968f943135eaa66e7738b2363ca2b81f71:260908-025502.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_chunkify_one_geomean}
\end{figure}

\subsection{Aos Chunkify One Linearrec}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_chunkify_one_linearrec.pdf}
  \caption{Comparison of \texttt{linearrec} speedups across core counts for \texttt{aos\_chunkify\_one\_linearrec}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_chunkify_one:260908-025502:flattening-tests:ab3558968f943135eaa66e7738b2363ca2b81f71:260908-025502.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_chunkify_one_linearrec}
\end{figure}

\subsection{Aos Chunkify One Quickhull}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{aos_chunkify_one_quickhull.pdf}
  \caption{Comparison of \texttt{quickhull} speedups across core counts for \texttt{aos\_chunkify\_one\_quickhull}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_aos_vs_aos_chunkify_one:260908-025502:flattening-tests:ab3558968f943135eaa66e7738b2363ca2b81f71:260908-025502.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:aos_chunkify_one_quickhull}
\end{figure}

\subsection{Soa Vs Aos Geomean}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{soa_vs_aos_geomean.pdf}
  \caption{Comparison of geometric mean speedups across core counts for \texttt{soa\_vs\_aos\_geomean}. Data: \protect\nolinkurl{mpl_aos_mpl_parallel_o3_morecores:260825-125551:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-125551.processed.jsonl}, \protect\nolinkurl{mpl_soa_mpl_parallel_o3_morecores:260825-191404:flattening-tests:475993b514ca4e4f6921a54f390c1ba9bc2350a1:260825-191404.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
...
\begin{figure}[H]
  ...
  \caption{Comparison of benchmark performance for \texttt{mlton\_con\_chunkify\_one\_mlton\_bench} on the MLton benchmark suite. Data: \protect\nolinkurl{test_conapp_flatten_test_o3:flattening-tests:cd5550ce5:20260909_171650.jsonl}, \protect\nolinkurl{mlton_only_chunkify_one:flattening-tests:5894a329f:20260907_204709.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:mlton_con_chunkify_one_mlton_bench}
\end{figure}

\subsection{Mlton Aos Vs Soa Parallel Bench}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{mlton_aos_vs_soa_parallel_bench.pdf}
  \caption{Comparison of benchmark performance for \texttt{mlton\_aos\_vs\_soa\_parallel\_bench} on the \texttt{parallel-ml-bench} benchmark suite. Data: \protect\nolinkurl{mlton_aos_mlton_parallel_o3:260824-220328:flattening-tests:dcd9cf195eacea093ebe838dcb1d190333218ffd:260824-220328.processed.jsonl}, \protect\nolinkurl{mlton_soa_mlton_parallel_o3:260824-234803:flattening-tests:dcd9cf195eacea093ebe838dcb1d190333218ffd:260824-234803.processed.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:mlton_aos_vs_soa_parallel_bench}
\end{figure}

\subsection{Mlton Aos Vs Soa Mlton Bench}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{mlton_aos_vs_soa_mlton_bench.pdf}
  \caption{Comparison of benchmark performance for \texttt{mlton\_aos\_vs\_soa\_mlton\_bench} on the MLton benchmark suite. Data: \protect\nolinkurl{test_aos_flatten_test_o3:flattening-tests:cd5550ce5:20260909_131724.jsonl}, \protect\nolinkurl{test_soa_flatten_test_o3:flattening-tests:cd5550ce5:20260909_151708.jsonl}. <0\% represents an improvement, >0\% represents a regression.}
  \label{fig:mlton_aos_vs_soa_mlton_bench}
\end{figure}
...
\clearpage
\subsection{Aos Sync Gc Flattening}

\subsubsection{\texttt{parallel-ml-bench}: MPL vs MPL (Aos Sync Gc Flattening)}

\paragraph*{Run time}
\importcsv{aos_sync_gc_parallel_bench_run_mpl_vs_mpl.csv}

\paragraph*{Binary size}
\importcsv{aos_sync_gc_parallel_bench_size_mpl_vs_mpl.csv}

\clearpage
\subsection{Aos Fixed Iters Flattening}

\subsubsection{\texttt{parallel-ml-bench}: MPL vs MPL (Aos Fixed Iters Flattening)}

\paragraph*{Run time}
\importcsv{aos_fixed_iters_parallel_bench_run_mpl_vs_mpl.csv}

\paragraph*{Binary size}
\importcsv{aos_fixed_iters_parallel_bench_size_mpl_vs_mpl.csv}

\clearpage
\subsection{Soa Sync Gc Flattening}

\subsubsection{\texttt{parallel-ml-bench}: MPL vs MPL (Soa Sync Gc Flattening)}

\paragraph*{Run time}
\importcsv{soa_sync_gc_parallel_bench_run_mpl_vs_mpl.csv}

\paragraph*{Binary size}
\importcsv{soa_sync_gc_parallel_bench_size_mpl_vs_mpl.csv}

\clearpage
\subsection{Soa Fixed Iters Flattening}

\subsubsection{\texttt{parallel-ml-bench}: MPL vs MPL (Soa Fixed Iters Flattening)}

\paragraph*{Run time}
\importcsv{soa_fixed_iters_parallel_bench_run_mpl_vs_mpl.csv}

\paragraph*{Binary size}
\importcsv{soa_fixed_iters_parallel_bench_size_mpl_vs_mpl.csv}
...
\subsubsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (AoS Flattening))}

\importcsv{linearrec_default_aos_mpl_parallel_ml_bench_scatter.csv}

\subsubsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (Aos Sync Gc Flattening))}

\importcsv{linearrec_sync_gc_aos_mpl_parallel_ml_bench_scatter.csv}

\subsubsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (AoS Flattening))}

\importcsv{quickhull_default_aos_mpl_parallel_ml_bench_scatter.csv}

\subsubsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (Aos Sync Gc Flattening))}

\importcsv{quickhull_sync_gc_aos_mpl_parallel_ml_bench_scatter.csv}

\subsubsection{\texttt{linearrec} (\texttt{parallel-ml-bench}: MPL (Aos Fixed Iters Flattening))}

\importcsv{linearrec_fixed_iters_aos_mpl_parallel_ml_bench_scatter.csv}

\subsubsection{\texttt{quickhull} (\texttt{parallel-ml-bench}: MPL (Aos Fixed Iters Flattening))}

\importcsv{quickhull_fixed_iters_aos_mpl_parallel_ml_bench_scatter.csv}
...
\subsubsection{Aos Exp Geomean}

\importcsv{aos_exp_geomean.csv}

\subsubsection{Aos Sync Gc Geomean}

\importcsv{aos_sync_gc_geomean.csv}

\subsubsection{Aos Sync Gc Linearrec}

\importcsv{aos_sync_gc_linearrec.csv}

\subsubsection{Aos Sync Gc Quickhull}

\importcsv{aos_sync_gc_quickhull.csv}

\subsubsection{Aos Fixed Iters Geomean}

\importcsv{aos_fixed_iters_geomean.csv}

\subsubsection{Aos Fixed Iters Linearrec}

\importcsv{aos_fixed_iters_linearrec.csv}

\subsubsection{Aos Fixed Iters Quickhull}

\importcsv{aos_fixed_iters_quickhull.csv}

\subsubsection{Aos Chunkify One Geomean}

\importcsv{aos_chunkify_one_geomean.csv}

\subsubsection{Aos Chunkify One Linearrec}

\importcsv{aos_chunkify_one_linearrec.csv}

\subsubsection{Aos Chunkify One Quickhull}

\importcsv{aos_chunkify_one_quickhull.csv}

\subsubsection{Soa Vs Aos Geomean}

\importcsv{soa_vs_aos_geomean.csv}
...
\subsubsection{Mlton Aos Vs Soa Parallel Bench}

\importcsv{mlton_aos_vs_soa_parallel_bench.csv}

\subsubsection{Mlton Aos Vs Soa Mlton Bench}

\importcsv{mlton_aos_vs_soa_mlton_bench.csv}
