...
A grammar for this intermediate representation is provided in \cref{fig:ssa_grammar}. Mirroring
MLton's representation of \texttt{SSA}, a program consists of datatype declarations,
global statement bindings, and a collection of first-order functions. Each function body
is represented as a control flow graph of basic blocks carrying explicit block arguments in place
of $\phi$-nodes.
...
\begin{figure}[htbp]
  ...
  \begin{align*}
    ...
    &\quad \mid \texttt{case} \;\langle\textit{operand}\rangle \;\texttt{of} \;\langle\textit{case\_arms}\rangle \\[0.3em]
    \langle\textit{case\_arms}\rangle &\Coloneqq \langle\textit{case\_arm}\rangle \;(\texttt{|} \;\langle\textit{case\_arm}\rangle)^* \\[0.3em]
