...
\begin{figure}[htbp]
  ...
  \begin{align*}
    ...
    &\quad \mid \texttt{call} \;\langle\textit{id}\rangle \;\langle\textit{id}\rangle \;\texttt{(} \,[\langle\textit{arg\_list}\rangle]\, \texttt{)} \mid \texttt{call} \;\langle\textit{id}\rangle \;\texttt{(} \;\langle\textit{id}\rangle \;\texttt{(} \,[\langle\textit{arg\_list}\rangle]\, \texttt{)} \;\texttt{)} \\
    ...
    \langle\textit{type}\rangle &\Coloneqq \langle\textit{id}\rangle \mid \langle\textit{tuple\_type}\rangle \mid \langle\textit{type}\rangle \;\texttt{array} \mid \langle\textit{type}\rangle \;\texttt{vector} \\[0.3em]
    \langle\textit{tuple\_type}\rangle &\Coloneqq \langle\textit{type}\rangle \;(\mathbin{\texttt{*}} \;\langle\textit{type}\rangle)^+ \mid \texttt{(} \;\langle\textit{type}\rangle \;(\mathbin{\texttt{*}} \;\langle\textit{type}\rangle)^+ \;\texttt{)} \\[0.3em]
