...
\citet{mlton-proj}, with a parallel variant MaPLe intreoduced in
...
codegen (as documented on \citet{mlton-website}):

%% http://mlton.org/IntermediateLanguage

\hl{TODO(agy): Add a diagram (in addition to text) that shows this flow}
