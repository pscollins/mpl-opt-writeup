...
\hl{TODO(agy): add ``mlton con chunkify one mlton bench'' as the figure referenced above}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{../analysis/charts/mlton_con_chunkify_one.pdf}
