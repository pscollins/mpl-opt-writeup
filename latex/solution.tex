...
\newcommand{\thesistitle}{Cache-efficient Memory Layouts in Standard ML}
\newcommand{\thesisauthor}{Patrick Collins}
\newcommand{\thesisadvisor}{Sam Westrick}

\newcommand{\gradmonth}{January}
\newcommand{\gradyear}{2027}
...
\input{chapters/preflatten}

\chapter{\texttt{ShallowFlatten}} \label{ch:shallowflatten}
\input{chapters/shallowflatten}
