...
\hl{If we want to discuss SSA vs SSA2, we need to flesh out SSA2 more. Consider
  ...
  we didn't use a different representation). Biggest conceptual difference: SSA2 allows ``nested'' addressing into fields, i.e. t = A[i]; x = load(t, 1) -> x = A[i, 1]}
