...
\begin{figure}[htbp]
  \centering
  % If using a subdirectory, it would be: \includegraphics[width=\textwidth]{figures/mlton_runtime_comparison.pdf}
  \includegraphics[width=0.8\textwidth]{../analysis/charts/tuple_mlton_run_mlton_vs_mlton.pdf}
  \caption{Relative runtime comparison between MLton0 and MLton1. The baseline is represented at 0\%, with negative values indicating a performance improvement.}
  \label{fig:mlton_runtime}
\end{figure}
