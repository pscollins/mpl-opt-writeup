...
It is similarly necessary to apply the transformation iteratively, since the
input to construct a nested-flattenable type are themselves flattenable types,
i.e.:
\begin{minted}{python}
  ((a * b) array * c) array ->
   (
