...
\begin{figure}[htbp]
  ...
  \caption{Relative run time for with- vs without-\texttt{PreFlatten}, applied to tuple constructors. <0\% represents an improvement, >0\% represents a regression.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{../analysis/charts/con_mlton_size_mlton_vs_mlton.pdf}
  \caption{Relative binary size for with- vs without-\texttt{PreFlatten}, applied to tuple constructors. <0\% represents an improvement, >0\% represents a regression.}
