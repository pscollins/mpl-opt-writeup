...
\begin{minted}{cpp}
  struct Lambda1 {
    ...
    // Optional data member for the xEnv_addWithBias case
    void *data;
  };
\end{minted}
...
corresponding to \texttt{Env} cases that are no longer reachable, etc.

\hl{TODO: EXPLAIN CONAPP}
...
\section{Further Flattening Optimizations}
\hl{TODO: separate sections for PreFlatten / ShallowFlatten}


\hl{TODO: TUPLE AND CON APP FLATTENING}

\hl{We might want to expand the discussion above to include some discussion
  about defunctionalization and the memory layout of ADTs}

\subsection{\texttt{ShallowFlatten}}
