...
\hl{TODO: CONFIRM -- DOES THE PARALLEL SCAN PRODUCE TEMPORARY ARRAYS OF TUPLES?
  DO THE TEMPORARY TUPLES GET ELIDED?}
...
For \texttt{quickhull}, we can see the single-threaded effect in \cref{tab:perf_comparison_aos_quickhull_1core}
