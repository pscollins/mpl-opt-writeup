...
\hl{TODO(agy): fill in the charts ``quickhull MPL AOS flattening scatter chart''
  + ``linearrec MPL AOS flattening scatter chart'' as
  fig:quickhull\_linearrec\_aos\_scatter\_plot

  Fill in the charts that compare geomean/quickhull/linearrec for
  fig\_quickhull\_linearrec\_aos\_fixed\_trials

  Fill in the full ``AOS fixed trial'' plots for fig:aos\_full\_fixed\_trial

  Fill in in teh charts that compare geomean/quickhull/linearrec for
  fig:quickhull_linearrec_aos_sync_gc

  Fill in the other missing charts in this following the same pattern}
...
\hl{TODO: ADD COMPARISON CHART FOR GEOMEAN AND CONCLUDE THAT IT IS THE SAME}
