...
\begin{minted}{python}
  def call3() -> int:
    block bb0():
      biasArg: int = 5
      env: lambda_1 = con xEnv_addWithBias (biasArg)
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  n: int = prim Array_length[a * b * ...](arr)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a = select (arr, 0)
  n: int = prim Array_length[a](arr_a)
\end{minted}
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  # Read element i
  x: (a * b * ...) = prim Array_sub[a * b * ...](arr, i)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a: a array = select (arr, 0)
  x_a: a = prim Array_sub[a](arr_a, i)
  arr_b: b array = select (arr, 1)
  x_b: b = prim Array_sub[b](arr_b, i)
  ...
  x: (a * b * ...) = tuple(x_a, x_b, ...)
\end{minted}
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  x: (a * b * ...) = ...
  _ = prim Array_update[a * b * ...](arr, i, x)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a: a array = select (arr, 0)
  x_a: a = select (x, 0)
  _ = prim Array_update[a](arr_a, i, x_a)
  arr_b: b array = select (arr, 1)
  x_b: b = select (x, 1)
  _ = prim Array_update[b](arr_b, i, x_b)
  ...
\end{minted}
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  isNop: bool = prim Array_uninitIsNop[(a * b * ...) array](arr)
  -->
  isNop: bool = false
\end{minted}
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  _ = prim Array_uninit[a * b * ...](arr, n)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a: a array = select (arr, 0)
  _ = prim Array_uninit[a](arr_a, n)
  arr_b: b array = select (arr, 1)
  _ = prim Array_uninit[b](arr_b, n)
  ...
\end{minted}
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  arr': (a * b * ...) array = prim Array_toArray[a * b * ...](arr)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a: a array = select (arr, 0)
  arr'_a: a array = prim Array_toArray[a](arr_a)
  arr_b: b array = select (arr, 1)
  arr'_b: b array = prim Array_toArray[b](arr_b)
  ...
...
\begin{minted}{python}
  arr: (a * b * ...) array = ...
  vec: (a * b * ...) vector = prim Array_toVector[a * b * ...](arr)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: (a array * b array * ...) = ...
  arr_a: a array = select (arr, 0)
  vec_a: a vector = prim Array_toVector[a](arr_a)
  arr_b: b array = select (arr, 1)
  vec_b: b vector = prim Array_toVector[b](arr_b)
  ...
...
\begin{minted}{python}
  vec: (a * b * ...) vector = ...
  n: int = prim Vector_length[a * b * ...](vec)
  -->
  # Earlier action of the pass means that now we have:
  #   vec: (a vector * b vector * ...) = ...
  vec_a = select (vec, 0)
  n: int = prim Vector_length[a](vec_a)
\end{minted}
...
\begin{minted}{python}
  vec: (a * b * ...) vector = ...
  # Read element i
  x: (a * b * ...) = prim Vector_sub[a * b * ...](vec, i)
  -->
  # Earlier action of the pass means that now we have:
  #   vec: (a vector * b vector * ...) = ...
  vec_a: a vector = select (vec, 0)
  x_a: a = prim Vector_sub[a](vec_a, i)
  vec_b: b vector = select (vec, 1)
  x_b: b = prim Vector_sub[b](vec_b, i)
  ...
  x: (a * b * ...) = tuple(x_a, x_b, ...)
\end{minted}
...
\begin{minted}{python}
  ...
  x: a array = prim Array_alloc[a](n')
\end{minted}
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  n: int = prim Array_length[a * a * ...](arr)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: a array = ...
  tupleSize: int = tupleWidth(a * a * ...)
  n': int = prim Array_length[a](arr)
  n: int = n' / tupleSize
\end{minted}
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  # Read element i
  x: (a * a * ...) = prim Array_sub[a * a * ...](arr, i)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: a array = ...
  tupleSize: int = tupleWidth(a * a * ...)
  x_0: a = prim Array_sub[a](arr, i * tupleSize)
  x_1: a = prim Array_sub[a](arr, i * tupleSize + 1)
  ...
  x_n: a = prim Array_sub[a](arr, i * tupleSize + tupleSize - 1)
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  x: (a * a * ...) = ...
  _ = prim Array_update[a * a * ...](arr, i, x)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: a array = ...
  tupleSize: int = tupleWidth(a * a * ...)
  ...
  x_1: a = select(x, 1)
  ...
  _ = prim Array_update[a](arr, i * tupleSize + 0, x_0)
  _ = prim Array_update[a](arr, i * tupleSize + 1, x_1)
  ...
\end{minted}
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  isNop: bool = prim Array_uninitIsNop[(a * a * ...) array](arr)
  -->
  isNop: bool = false
\end{minted}
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  _ = prim Array_uninit[a * a * ...](arr, n)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: a array = ...
  tupleSize: int = tupleWidth(a * a * ...)
  _ = prim Array_uninit[a](arr, n * tupleSize)
  _ = prim Array_uninit[a](arr, n * tupleSize + 1)
  ...
  _ = prim Array_uninit[a](arr, n * tupleSize + tupleSize - 1)
\end{minted}
...
\begin{minted}{python}
  arr: (a * a * ...) array = ...
  vec: (a * a * ...) vector = prim Array_toVector[a * a * ...](arr)
  -->
  # Earlier action of the pass means that now we have:
  #   arr: a array = ...
  vec: a vector = prim Array_toVector[a](arr)
\end{minted}
...
\begin{minted}{python}
  vec: (a * a * ...) vector = ...
  # Read element i
  x: (a * a * ...) = prim Vector_sub[a * a * ...](vec, i)
  -->
  # Earlier action of the pass means that now we have:
  #   vec: a vector = ...
  tupleSize: int = tupleWidth(a * a * ...)
  x_0: a = prim Vector_sub[a](vec, i * tupleSize)
  x_1: a = prim Vector_sub[a](vec, i * tupleSize + 1)
  ...
  x_n: a = prim Vector_sub[a](vec, i * tupleSize + tupleSize - 1)
  x: (a * a * ...) = tuple(x_0, x_1, ..., x_n)
\end{minted}
...
\subsubsection{\texttt{delaunay} vs \texttt{bfs}: observed IR change}
...
\subsubsection{\texttt{delaunay} vs \texttt{bfs}: microarchitectural effects}
...
Beginning with \texttt{delaunay}, we have, for a single core (in \cref{tab:perf_comparison_delaynay_1core}):
    \begin{table}[htbp]
      \centering
...
Examining the same benchmark at 160 cores, we get (in \cref{tab:perf_comparis_delaunay_160cores}):
\begin{table}[htbp]
  \centering
...
\subsubsection{\texttt{delaunay} vs \texttt{bfs}: control for known effects}
...
\subsubsection{\texttt{wc-input1}: detailed analysis}
...
\FloatBarrier
\subsection{\texttt{wc-input1}: controlling for \texttt{Chunkify}}
...
\subsubsection{\texttt{quickhull}, \texttt{linearrec}: observed IR change}
...
\subsubsection{\texttt{quickhull}, \texttt{linearrec}: microarchitectural effects}
...
\subsubsection{\texttt{quickhull}, \texttt{linearrec}: control for known effects}
